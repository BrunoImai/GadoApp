...
class _MachineInfoPageState extends State<MachineInfoPage> {
  ...
  String productName = "Ensiladeira";
  String batch = "9839";
  String localization = "Curitiba/PR";
  int qtt = 1;
  String price = "75.000,00";
  String priceType = "unid";
          ...
          Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                    """  Equipamento utilizado para picar capins, cana-de-açúcar, milho e etc. Foi projetada para produzir com qualidade a alimentação no trato de animais. Proporciona mais comodidade ao operador, por puxar mecanicamente os leguminos para dentro da área de processo, através de 2 rolos puxadores. Equipamento constituído em aço, para excelente durabilidade e com Pintado a Pó (Eletrostática).""",
                    style: TextStyle(
